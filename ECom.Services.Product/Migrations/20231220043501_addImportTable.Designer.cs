...
namespace ECom.Services.Products.Migrations
{
    ...
    [Migration("20231220043501_addImportTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.ImportDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.Importing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.Collection", b =>
                {
                    b.HasOne("ECom.Services.Products.Models.Discount", "Discount")
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.HaveTag", b =>
                {
                    b.HasOne("ECom.Services.Products.Models.Product", "Product")
                        .WithMany("HaveTags")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECom.Services.Products.Models.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.ImportDetail", b =>
                {
                    b.HasOne("ECom.Services.Products.Models.Importing", "Importing")
                        .WithMany("ImportDetails")
                        .HasForeignKey("ImportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECom.Services.Products.Models.ProductItem", "ProductItem")
                        .WithMany()
                        .HasForeignKey("Item")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.Product", b =>
                {
                    b.HasOne("ECom.Services.Products.Models.Collection", "Collection")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ECom.Services.Products.Models.ProductItem", b =>
                {
                    b.HasOne("ECom.Services.Products.Models.Product", null)
